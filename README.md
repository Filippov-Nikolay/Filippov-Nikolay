<!-- Profile Header -->
<h1 align="left">Hi, I'm Nikolay - Full-Stack Developer</h1>
<p align="left">
...
### 🚀 About me
- Full-Stack Developer with a strong foundation in **C++**, **C#**, **JavaScript**, **TypeScript**
- I specialize in **Angular**, **React**, **Node.js**, **ASP.NET**
- Proficient in **OOP** & **procedural programming**
- Confident with **multithreading** and **client-server architecture**
- Apply **Design Patterns** (Creational, Structural, Behavioral) and **UML** in software design
- Committed to **clean, efficient, maintainable** code
...
![Material%20UI](https://img.shields.io/badge/Material%20UI-007FFF?logo=mui&logoColor=white&style=for-the-badge)
...
![SSMS](https://img.shields.io/badge/SQL%20Server%20Management%20Studio-CC2927?logo=microsoftsqlserver&logoColor=white&style=for-the-badge)
